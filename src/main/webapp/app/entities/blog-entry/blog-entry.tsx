      ...
      <div>
        <h2 id="blog-entry-heading">
          ...
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            ...
            &nbsp;
            <Translate contentKey="blogApp.blogEntry.home.createLabel">Create a new Blog Entry</Translate>
          </Link>
        </h2>
          ...
          >
            {blogEntryList && blogEntryList.length > 0 ? (
              ...
              <div className="alert alert-warning">
                <Translate contentKey="blogApp.blogEntry.home.notFound">No Blog Entries found</Translate>
              </div>
            )}
          </InfiniteScroll>
        </div>
